...
#define ILI9341_T4_MADCTL_MY  0x80
#define ILI9341_T4_MADCTL_MX  0x40
#define ILI9341_T4_MADCTL_MV  0x20
#define ILI9341_T4_MADCTL_ML  0x10
#define ILI9341_T4_MADCTL_RGB 0x00
#define ILI9341_T4_MADCTL_BGR 0x08
#define ILI9341_T4_MADCTL_MH  0x04
...
public:
    ...
    **/
    ...
    /** for special use (do not use it if you do not know why) ... */
    void _setRealOrientation(uint8_t m);
...
private:
    ...
    ***********************************************************************************************************/
    ...
    DiffBuffDummyRot _ddrot;
    volatile int _TLX, _TLY; 
