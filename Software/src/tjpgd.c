...
SLOWFUN static void* alloc_pool(	/* Pointer to allocated memory block (NULL:no memory available) */
...
SLOWFUN static JRESULT create_qt_tbl(	/* 0:OK, !0:Failed */
	JDEC* jd,				/* Pointer to the decompressor object */
...
SLOWFUN static JRESULT create_huffman_tbl(	/* 0:OK, !0:Failed */
	JDEC* jd,					/* Pointer to the decompressor object */
...
SLOWFUN static JRESULT restart(
	JDEC* jd,		/* Pointer to the decompressor object */
...
SLOWFUN static void block_idct(
...
SLOWFUN static JRESULT mcu_load(
	JDEC* jd		/* Pointer to the decompressor object */
)
	{
...
SLOWFUN static JRESULT mcu_output(
	JDEC* jd,			/* Pointer to the decompressor object */
